...
@Component({
  ...
  styleUrls: [
    "./master-report-maintenance-settlement.component.scss",
  ...
  providers: [
    I18n,
    {
      ...
      useClass: MasterReportMaintenanceSettlementComponent,
    },
  ],
})
  ...
  getFilters() {
    ...
    if (this.selectedRegionalId == 0) {
      ...
      if (cont >= 1) {
        ...
        console.log(".---------->" + params);
        this.reportService
          .getMaintenanceSettlement(params)
          .then((data) => {
            const resp: any = data;
            ...
            this.exportAsExcelFile(
              this.dataExcels,
              "Informe Controles Liquidados " + fromD + " - " + untilD
            );
            swal.close();
