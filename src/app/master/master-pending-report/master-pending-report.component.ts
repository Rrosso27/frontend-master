...
@Component({
  ...
  styleUrls: [
    "./master-pending-report.component.scss",
    "../../../assets/icon/icofont/css/icofont.scss",
  ],
  providers: [
    I18n,
    { provide: NgbDatepickerI18n, useClass: MasterPendingReportComponent },
  ],
})
        ...
        this.reportService
          ...
          .then((data) => {
            ...
            this.exportAsExcelFile(
              this.dataExcels,
              "Informe de Pendientes de Equipos " + fromD + " - " + untilD
            );
            swal.close();
  ...
  public exportAsExcelFile(rows: any[], excelFileName: string): void {
    if (rows.length > 0) {
      ...
      const workbook: XLSX.WorkBook = {
        Sheets: { "info-pendientes": worksheet },
        SheetNames: ["info-pendientes"],
      };
