...
@Component({
  ...
  styleUrls: [
    "./master-estimate-customer.component.scss",
...
export class MasterEstimateCustomerComponent implements OnInit {
  ...
  constructor(
    ...
    private excelService: FilexcelService,
    private workService: WorkService,
    private uploadService: UploadService,
    private forkliftService: ForkliftService,
    private resumeneServices: ResumenesService
  ) {
    ...
    this.estimateService
      ...
      .then((data) => {
        ...
        this.consecutive = Number(
          yearCosecutive.toString() +
            month.toString() +
            this.consecutive.toString()
        );
      })
      .catch((error) => {
        console.log(error);
  ...
  getEstimateDetails() {
    if (this.estimateId) {
      this.estimateService
        .getEstimateDetails(this.estimateId)
        .then((data) => {
          const resp: any = data;
          ...
          for (let i = 0; i < this.rowsItems.length; i++) {
            this.itemEnd.push(
              +i +
                1 +
                "," +
                this.rowsItems[i].code +
                "," +
                this.rowsItems[i].description +
                "," +
                this.rowsItems[i].quantity +
                "," +
                this.rowsItems[i].unit_cost +
                "," +
                this.rowsItems[i].price +
                "," +
                this.rowsItems[i].delivery
            );
          }
        })
        .catch((error) => {
  ...
  getEstimateWorkforce() {
    if (this.estimateId) {
      this.estimateService
        .getEstimateDetailsWorkforce(this.estimateId)
        .then((data) => {
          const resp: any = data;
  ...
  getEstimateParts() {
    if (this.estimateId) {
      this.estimateService
        .getEstimateDetailsParts(this.estimateId)
        .then((data) => {
          const resp: any = data;
  ...
  getCities() {
    this.restService
      .getCities(this.selectedDepartmentId)
      .then((data) => {
        const resp: any = data;
        swal.close();
  ...
  createEstimateDetail() {
    ...
    if (
      Number(priceTemp) >= Number(this.lowPrice) &&
      Number(priceTemp) <= Number(this.higherPrice)
    ) {
      ...
      let totalTemp = this.changeFormatDecimal(this.subtotal); //this.subtotal.toString().replace('.','').
  ...
  updateEstimateDetail() {
    ...
    this.higherPriceUpdate = Number(
      this.lowPriceUpdate * (1 + this.suggestedMaximum / 100)
    ).toFixed(0);
    // cambio YCV

    if (
      Number(priceUpdateTemp) >= Number(this.lowPriceUpdate) &&
      Number(priceUpdateTemp) <= Number(this.higherPriceUpdate)
    ) {
      ...
      let priceSuggestTemp = this.changeFormatDecimal(
        this.suggestedPriceUpdate
      );
  ...
  sendPriceCountries() {
    ...
    if (!this.myForm.invalid) {
      ...
      this.estimateService
        .createPriceCountries(
          Number(this.selectedEstimateCountryId.id),
          this.myForm.get("weight").value.toUpperCase(),
          this.myForm.get("price").value.toUpperCase()
        )
        .then((data) => {
          const resp: any = data;
  ...
  ChangingValue() {
    ...
    this.estimateService
      .getPriceDhlCountry(Number(this.selectedEstimateCountryId.id))
      .then((data) => {
        const resp: any = data;
  ...
  sendUpdatePriceCountries() {
    ...
    if (!this.myFormUpdate.invalid) {
      ...
      swal.showLoading();
      this.estimateService
        .updatePriceCountries(
          Number(this.currentCountry.id),
  ...
  updateItems(item: any) {
    ...
    this.suggestedPriceUpdate = this.finalFormatStandard(
      Number(item.price_suggest).toFixed(0)
    );
    this.priceUpdate = this.finalFormatStandard(Number(item.price).toFixed(0));
    this.subtotalUpdate = this.finalFormatStandard(
  ...
  updateWorkForceItems(item: any) {
    ...
    this.workforceHourValueUpdate = this.finalFormatStandard(
      Number(item.hour_value).toFixed(0)
    );
  ...
  deletePriceCountry(item: any) {
    swal({
      ...
      if (willDelete.value) {
        ...
        swal.showLoading();
        this.estimateService
          .deletePriceCountries(Number(this.elementDelete.id))
          .then((data) => {
            swal.showLoading();
            const resp: any = data;
            if (resp.success === false) {
  ...
  deleteEstimateDetail(item: any) {
    swal({
      ...
      if (willDelete.value) {
        ...
        swal.showLoading();
        this.estimateService
          .deleteEstimateDetail(Number(this.elementDelete.id))
          .then((data) => {
            swal.showLoading();
            const resp: any = data;
    ...
    this.estimateService
      ...
      .then((data) => {
        ...
        if (this.conditionTrmUsa.id == 2) {
          if (this.conditionTrmUsa.id == 2) {
            this.trmGeneralUsa = Number(this.conditionTrmUsa.constant).toFixed(
              2
            );
            this.trmGeneralEsp = (
              this.trmGeneralUsa * this.conditionTrmEsp.constant
            ).toFixed(2);
          }
        } else {
          let trm;
          trmapi
            ...
            .then((data) => {
              ...
              if (this.conditionTrmUsa.id == 3) {
                this.trmGeneralUsa =
                  trm + Math.trunc(this.conditionTrmUsa.constant);
              }
  ...
  getPendingForklift() {
    this.resumeneServices
      .getForkliftPendingGeneral(this.selectedForkliftId.id)
      .then((data) => {
        const resp: any = data;
  ...
  updateStatusBatteryPending(id: number, status: number) {
    this.resumeneServices
      .updateStatusPendingBattery(id, status, this.consecutive, this.estimateId)
      .then((data) => {
        const resp: any = data;
        swal.close();
      })
  ...
  createEstimateDetailWorkforcePending(item: any, status: number) {
    ...
    this.estimateService
      .createEstimateDetailWorkforceForPending(
        estimateIdTemp,
        serviceTemp,
        statusTemp,
        typeService
  ...
  showShippingCountriesDhl(
    conditionValidation: number,
    country: number,
    weight: number,
    ind: number
  ) {
    // ind 0:create, 1:update

    let priceTemp = 0;

    for (let item of this.showShippingCountriesDhlFilter) {
      if (
        item.estimate_countries_id == country &&
        item.conexion_id_validation_front == conditionValidation
      ) {
  ...
  showCountryWeight(country: number, weight: number, ind: number) {
    this.estimateService
      .showCountryWeight(country, weight)
      .then((data) => {
        const resp: any = data;
  ...
  calculateFreightValues() {
    if (
      ...
      if (this.priceList == 5 || this.priceList == 6) {
        if (this.priceList == 5) {
          this.suggestedPrice = Number(
            Number(this.unitCost / this.thirdService).toFixed(0)
          );
          this.price = this.suggestedPrice;
          this.subtotal = this.suggestedPrice * this.quantity;
          this.lowPrice = this.suggestedPrice;
          this.higherPrice = Number(
            this.suggestedPrice * (1 + this.suggestedMaximum / 100)
          ).toFixed(0);
        } else if (this.priceList == 6) {
          this.suggestedPrice = Number(
            Number(this.unitCost / this.nationalService).toFixed(0)
          );
          this.price = this.suggestedPrice;
          this.subtotal = this.suggestedPrice * this.quantity;
          this.lowPrice = this.suggestedPrice;
  ...
  calculateFreightValuesUpdate() {
    if (
      ...
      this.quantityUpdate !== 0
    ) {
      if (this.priceListUpdate == 5 || this.priceListUpdate == 6) {
        if (this.priceListUpdate == 5) {
          this.suggestedPrice = Number(
            Number(this.unitCostUpdate / this.thirdService).toFixed(0)
          );
          ...
          this.higherPriceUpdate = Number(
            this.suggestedPriceUpdate * (1 + this.suggestedMaximum / 100)
          ).toFixed(0);
        } else if (this.priceListUpdate == 6) {
          this.suggestedPriceUpdate = Number(
            Number(this.unitCostUpdate / this.nationalService).toFixed(0)
          );
          this.priceUpdate = this.suggestedPriceUpdate;
          this.subtotalUpdate = this.suggestedPriceUpdate * this.quantityUpdate;
          this.lowPriceUpdate = this.suggestedPriceUpdate;
    ...
    if (
      ...
      if (this.priceListUpdate == 7) {
        ...
        this.priceUpdate = this.suggestedPriceUpdate;
        this.subtotalUpdate = Number(
          this.suggestedPriceUpdate * this.quantityUpdate
        ).toFixed(0);
        this.lowPriceUpdate = this.suggestedPriceUpdate;
        this.higherPriceUpdate = Number(
          this.suggestedPriceUpdate * (1 + this.suggestedMaximum / 100)
  ...
  finalOperation(country: number) {
    ...
    if (this.conditionValidation == 3) {
      drivingCost =
        Number(this.managementVariables) +
        this.unitCost * (Number(this.managmentTariff) / 100);
    } else {
      drivingCost =
        this.unitCost * Number(this.managementVariables) +
        this.unitCost * (Number(this.managmentTariff) / 100); //10
    }
    ...
    if (this.conditionValidation == 2) {
      ...
      operationFreight =
        Number(Number(this.freightGeneral).toFixed(2)) * this.finalWeight;
    } else {
      operationFreight =
        Number(Number(this.freightGeneral).toFixed(2)) * this.finalWeight;
    }
  ...
  finalOperationUpdate(country: number) {
    ...
    if (this.conditionValidation == 3) {
      drivingCost =
        Number(this.managementVariables) +
        this.unitCostUpdate * (Number(this.managmentTariff) / 100);
    } else {
      drivingCost =
        this.unitCostUpdate * Number(this.managementVariables) +
        this.unitCostUpdate * (Number(this.managmentTariff) / 100); //10
    }
    ...
    if (this.conditionValidation == 2) {
      ...
      operationFreight =
        Number(Number(this.freightGeneral).toFixed(2)) * this.finalWeightUpdate;
    } else {
      operationFreight =
        Number(Number(this.freightGeneral).toFixed(2)) * this.finalWeightUpdate;
    }

    this.costTotalGlobalUpdate =
      Number(this.unitCostUpdate) +
      Number(operationFreight) +
      Number(drivingCost);
    ...
    this.subtotalUpdate = (
      Number(this.salePriceUpdate) * Number(this.quantityUpdate)
    ).toFixed(0);
  ...
  uploadFiles() {
    for (let fileCurrent of this.selectedFiles) {
      ...
      let nameTemp = this.removeAccents(
        this.consecutive + this.normalizes(file.name.replace(/\s/g, ""))
      );
      const extension = file.name
        .substring(file.name.lastIndexOf("."))
        .toLowerCase();
      this.uploadService
        .uploadFilesAll(file, this.estimateId, 0, nameTemp)
        .then((res) => {
          this.s3info = res;
          /*swal({
          title: 'Archivos guardados',
  ...
  uploadFilesImages() {
    for (let fileCurrent of this.selectedFilesImages) {
      ...
      this.uploadService
        .uploadFilesAll(img, this.estimateId, 1, nameTemp)
        .then((res) => {
          this.s3info = res;
  ...
  deleteImage(i: number) {
    if (this.showSaveFile == true) {
      ...
      swal({
        title:
          "No se permite eliminar la imagen, debes ir a editar la cotización",
        type: "error",
      });
    }
  }
   ...
   */
    ...
    doc.autoTable({
      startY: 7,
      columnStyles: {
        2: { cellWidth: 50, fontSize: 8, fillColor: null },
        1: { cellWidth: 140, fontSize: 8, halign: "left", fillColor: null },
        0: { cellWidth: 250, fontSize: 8, halign: "left", fillColor: null },
      },
    ...
    doc.autoTable({
      startY: 60,
      columnStyles: {
        2: { cellWidth: 105, fontSize: 9, fillColor: null },
        1: { cellWidth: 102, fontSize: 9, halign: "left", fillColor: null },
        0: { cellWidth: 88, fontSize: 9, halign: "left", fillColor: null },
      },
      alternateRowStyles: { fontSize: 9 },
      margin: { top: 60, right: 15, bottom: 0, left: 135 },
      body: [
        [
          "MONTACARGAS MASTER Nit. 900.204.935-2              Medellín - Colombia     ",
          "PBX. (57-4) 444 6055               CLL 10 B sur # 51 42",
          "",
        ],
      ],
    });
    ...
    doc.autoTable({
      startY: 85,
      columnStyles: {
        0: { cellWidth: 180, fontSize: 9, fillColor: null },
        1: {
          fontSize: 12,
          halign: "center",
          fillColor: null,
    ...
    doc.autoTable({
      ...
      columnStyles: {
        0: { cellWidth: 235, fontSize: 9, fillColor: null },
        1: { fontSize: 9, halign: "left", fillColor: null, cellWidth: 180 },
      },
      margin: { left: 15 },
      body: [
        [
          "Nit: " + this.documentCustomer + " " + this.nameCustomer,
    ...
    doc.autoTable({
      ...
      columnStyles: {
        0: { cellWidth: 100, fontSize: 9, fillColor: null },
        1: { fontSize: 9, halign: "left", fillColor: null, cellWidth: 100 },
        2: { fontSize: 9, halign: "left", fillColor: null, cellWidth: 214 },
      },
      margin: { left: 15 },
      body: [
        [
          ...
          "Ciudad: " + "Medellín",
          "Maquina: " + "CHEVROLEJTL CHR3566987893 123456543345",
        ],
      ],
    });
    ...
    var body_table = [];
    (body_table = ["David", "david@example.com", "Sweden"]),
      ["David", "david@example.com", "Sweden"],
      ["David", "david@example.com", "Sweden"];
    ...
    for (let i = 0; i < this.rowsItemsparts.length; i++) {
      body_table = [
        i + 1,
        this.rowsItemsparts[i].code,
        this.rowsItemsparts[i].description,
        this.rowsItemsparts[i].quantity,
        this.rowsItemsparts[i].unit_cost,
        this.rowsItemsparts[i].price,
      ...
      doc.autoTable({
        ...
        columnStyles: {
          0: { halign: "center", fontSize: 8, cellWidth: 23 },
          1: { halign: "center", fontSize: 8, cellWidth: 55 },
          2: { halign: "left", fontSize: 8, cellWidth: 185 },
          3: { halign: "center", fontSize: 8, cellWidth: 27 },
          4: { halign: "center", fontSize: 8, cellWidth: 40 },
          5: { halign: "center", fontSize: 8, cellWidth: 39 },
          6: { halign: "center", fontSize: 8, cellWidth: 42 },
        },
        margin: { left: 15 },
        body: [body_table],
      });
    ...
    doc.autoTable({
      ...
      styles: { fillColor: null, lineColor: [4, 1, 0], lineWidth: 0.2 },
      columnStyles: {
        0: { halign: "center", fontSize: 8, cellWidth: 85 },
        1: { halign: "center", fontSize: 8, cellWidth: 86 },
        2: { halign: "left", fontSize: 8, cellWidth: 81 },
        3: { halign: "center", fontSize: 8, cellWidth: 80 },
        4: { halign: "center", fontSize: 8, cellWidth: 80 },
      },
      margin: { left: 15 },
      body: [
        [
          {
            content: "HNYUCW-00128",
            colSpan: 3,
            rowSpan: 3,
  ...
  upload() {
    this.uploadService
      .uploadFileForkliftUpdate4(this.imageps)
      .then((res) => {
        this.s3info = res;
      })
      .catch((error) => {
  ...
  upload3(image: any) {
    this.uploadService
      .uploadFileForkliftUpdate3(image)
      .then((res) => {
        this.s3info = res;
        //this.insertNew();
      })
  ...
  createEstimate() {
    ...
    this.estimateService
      .createEstimate(
        consecutiveTemp,
        customerIdTemp,
        documentCustomerTemp,
        idDepartmentTemp,
        selectedCityTemp,
        selectedForkliftIdTemp,
        contactTemp,
        daysTemp,
        guarantyTemp,
        validityTemp,
      ...
      .then((data) => {
        ...
        this.estimateService
          ...
          .catch((error) => {
            swal({
              title:
                "Se presento un problema, para guardar este encabezado cotización",
              type: "error",
            });
            console.log(error);
          });
  ...
  createEstimateDetailWorkforce() {
    ...
    let subtotalTemp = this.changeFormatDecimal(this.workforceSubtotal);
  ...
  calculateSubtotalWork() {
    let workforceHourValueTemp = this.changeFormatDecimal(
      this.workforceHourValue
    );
  ...
  calculateSubtotalWorkUpdate() {
    let workforceHourValueTempUpdate = this.changeFormatDecimal(
      this.workforceHourValueUpdate
    );
  ...
  pp() {
    this.getBase64ImageFromUrl(
      "https://masterforklift.s3.amazonaws.com/estimate_files/ole.jpeg"
    )
