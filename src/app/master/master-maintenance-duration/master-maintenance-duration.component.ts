...
@Component({
  ...
  styleUrls: [
    "./master-maintenance-duration.component.scss",
  ...
  providers: [
    I18n,
    {
      ...
      useClass: MasterMaintenanceDurationComponent,
    },
  ],
})
        ...
        this.reportService
          ...
          .then((data) => {
            ...
            this.exportAsExcelFile(
              this.dataExcels,
              "Informe de Duración de Mantenimientos " + fromD + " - " + untilD
            );
            swal.close();
  ...
  public exportAsExcelFile(rows: any[], excelFileName: string): void {
    if (rows.length > 0) {
      ...
      const workbook: XLSX.WorkBook = {
        Sheets: { "Info-Dura-Mantenimientos": worksheet },
        SheetNames: ["Info-Dura-Mantenimientos"],
      };
