...
@Component({
  selector: 'app-master-view-resumenes-stevedore',
  templateUrl: './master-view-resumenes-stevedore.component.html',
  styleUrls: ['./master-view-resumenes-stevedore.component.scss']
})
export class MasterViewResumenesStevedoreComponent implements OnInit {
  ...
  getDetail(id: any){
    console.log(id);
      this.resumenesService.getMakeRoutineStevedore(id).then(data => {
        const resp: any = data;
        console.log(data);
  ...
  getTechnician(id: any){
    console.log(id);
      this.resumenesService.getTechnicianRoutineStevedore(id).then(data => {
        const resp: any = data;
        console.log(data);
  ...
  getPending(id: any){
    console.log(id);
      this.resumenesService.getPedingStevedore(id).then(data => {
        const resp: any = data;
        console.log(data);
  ...
  getDelivery(id: any){
    console.log(id);
      this.resumenesService.getDeliveryReviewStevedore(id).then(data => {
        const resp: any = data;
        console.log(data);
  ...
  getSupplice(id: any){
    console.log(id);
      this.resumenesService.getSuppliceStevedore(id).then(data => {
        const resp: any = data;
        console.log(data);
  ...
  getImages(id){
    console.log(id);
    this.resumenesService.getStevedoreImage(id).then(data => {
      const resp: any = data;
      console.log(data);
