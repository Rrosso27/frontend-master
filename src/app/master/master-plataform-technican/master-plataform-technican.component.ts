...
@Component({
  selector: 'app-master-plataform-technican',
  templateUrl: './master-plataform-technican.component.html',
  styleUrls: ['./master-plataform-technican.component.scss',
  '../../../assets/icon/icofont/css/icofont.scss'],
  providers: [I18n, {provide: NgbDatepickerI18n, useClass: MasterPlataformTechnicanComponent}]
})
export class MasterPlataformTechnicanComponent extends NgbDatepickerI18n {
  ...
  getPlataform() {
    ...
    swal.showLoading();
    this.platformService.getPlatforms().then(data => {
      const resp: any = data;
      if (resp.error) {
        swal({
          title:'Error',
