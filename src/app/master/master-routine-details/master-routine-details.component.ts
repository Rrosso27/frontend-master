...
@Component({
  selector: 'app-master-routine-details',
  templateUrl: './master-routine-details.component.html',
  styleUrls: ['./master-routine-details.component.scss',
  '../../../assets/icon/icofont/css/icofont.scss']
})
export class MasterRoutineDetailsComponent implements OnInit {
